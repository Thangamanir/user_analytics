...
import {FirebaseConfig,userId} from "./dev"
...
export const logged_events = firestore_dbref.collection("logged_events").where("uid","==",userId).orderBy('createdAt','desc').limit(100);
